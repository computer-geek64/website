...
\begin{document}
  ...
  {\fontsize{12}{12}\selectfont{
    ...
    | {\ebgaramonditalic{Options SRE Team}}
    | New York City, NY
    \hfill{}
    Sep '22 - Dec '22
  }}
  ...
  \begin{itemize}
    \item{Incoming software engineering intern at Citadel Securities, working on the Options Site Reliability Engineering team}
  \end{itemize}
  ...
  {\fontsize{12}{12}\selectfont{
    ...
    | Software Engineer Intern
    | {\ebgaramonditalic{Magnus Ranking Team}}, Search Science \& AI
    | Palo Alto, CA
    \hfill{}
    May '21 - Aug '21
  }}
  ...
  \begin{itemize}
    ...
    \item{
      ...
      Flask, FastAPI, Django, Pandas, PySpark, PyTorch, TensorFlow, Spring Boot, Pistache, Rails, OpenCV, SocketIO%, Selenium, JavaFX/Swing
    }
