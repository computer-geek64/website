...
% Fonts %
\newfontfamily{\ptserif}[Path=\fontspath]{PTSerif-Regular.ttf}
...
\newfontfamily{\sourceserif}[Path=\fontspath]{SourceSerifPro-Regular.ttf}
\newfontfamily{\sourceserifbold}[Path=\fontspath]{SourceSerifPro-Bold.ttf}
...
\begin{document}
  ...
  % Contact Information %
  \begin{center}
    {\fontsize{24}{24}\selectfont{\sourceserifbold{Ashish D'Souza}}}
    \\
  ...
  \ifmilesnap
    {\fontsize{12}{12}\selectfont{
      ...
      |
      {\ebgaramonditalic{PDI Winning Project at HackGT}}
  ...
  \begin{itemize}
    \item{
      HackGT 6 Hackathon
      \textemdash{}
      {\ebgaramonditalic{PDI Award for MileSnap Project}}
      (2019)
    }
